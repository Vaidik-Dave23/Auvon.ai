        ...
        <div className="min-h-screen bg-base p-6 flex gap-6">
            ...
            <div className="flex-1 animate-fade-in flex flex-col">
                ...
                <header className="mb-8">
                    <h1 className="text-4xl font-bold text-textMain tracking-tight mb-2">Notes</h1>
                    <p className="text-textMuted">Generate, read, and manage your AI-powered study materials.</p>
                </header>
